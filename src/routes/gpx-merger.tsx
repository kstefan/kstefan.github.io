  ...
  return   <div className="min-h-screen bg-gradient-subtle">
    ...
    <main className="container px-4 py-12">
      <div className="mx-auto max-w-4xl">
        ...
        {/*      className="flex min-h-[180px] flex-col items-center justify-center gap-3 rounded-xl border-2 border-dashed border-border bg-card/50 p-6 text-muted-foreground transition-all hover:border-primary/50 hover:bg-muted/50 hover:text-foreground"*/}
        {/*  >*/}
        ...
        {/* Info Section */}
        <div className="mt-16 rounded-2xl border border-border/50 bg-card p-8 shadow-soft animate-fade-in" style={{ animationDelay: "0.3s" }}>
